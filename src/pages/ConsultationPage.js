          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "start" }}>
            ...
            <div>
              ...
              <p style={{
                ...
                fontSize: "17px", lineHeight: 1.65, color: T.muted, marginBottom: "40px",
              }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1px", background: T.border, marginBottom: "32px" }}>
                {services.map(s => (
                  <div key={s.title} style={{
                    background: T.surface, padding: "28px",
                  ...
                  >
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "10px" }}>
                      <div style={{
                        ...
                        fontSize: "16px", color: T.text,
                      }}>{s.title}</div>
                      <div style={{ textAlign: "right" }}>
                        <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, color: s.color, fontSize: "18px" }}>{s.price}</div>
                        <div style={{ fontSize: "9px", color: T.muted, letterSpacing: "0.1em", textTransform: "uppercase" }}>{s.duration}</div>
                      </div>
                    </div>
                    <p style={{ fontSize: "12.5px", lineHeight: 1.7, color: T.muted }}>{s.desc}</p>
                  </div>
                ))}
              </div>
              ...
              <div style={{
                ...
                fontSize: "12px", color: T.muted, lineHeight: 1.7,
              }}>
            ...
            {/* Right: Form */}
            <div>
              <div style={{ background: T.surface, border: `1px solid ${T.border}`, padding: "40px" }}>
                <div style={{
                  fontFamily: "'Syne', sans-serif", fontWeight: 700,
      ...
      {submitted && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              fontFamily: "'Syne', sans-serif", fontSize: "56px",
            ...
            <p style={{ fontSize: "14px", lineHeight: 1.75, color: T.muted }}>
